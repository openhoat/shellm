# Claude Workflow for Adding Ideas to Backlog
...
- Priority: `🔴 P1`, `🟡 P2`, `🟢 P3`
- Category icons: `🔒 [SECURITY]`, `✅ [TEST]`, `🚀 [PERFORMANCE]`, `🏗️ [ARCHITECTURE]`, `🎨 [UX]`, `🔧 [DEVOPS]`, `🌍 [I18N]`, `📦 [DEPENDENCIES]`, `⚙️ [CONFIG]`

## Execution instructions

### 1. Read KANBAN.md

Read the content of the `/KANBAN.md` file at the project root.

### 2. Ask user for idea description

Request the description of the idea to add from the user.
...
Request the priority level from the user.
...
Request the category from the user.
...
Update the KANBAN.md file to add the idea to the appropriate priority subsection within "## 📝 Backlog".
...
- [ ] **[DD/MM/YYYY HH:mm:ss] 🔴 P1 CategoryEmoji [CATEGORY]** New idea
- [ ] **[DD/MM/YYYY HH:mm:ss] 🔴 P1 CategoryEmoji [CATEGORY]** Existing idea 1
```
...
9. Create entry: - [ ] **[12/02/2026 10:30:15] 🟡 P2 🎨 [UX]** Add support for keyboard shortcuts
...
The user can trigger this workflow by asking Claude to:
- "Add an idea to the backlog"
- "Add this to the kanban backlog"
- "I have a feature idea to add to the backlog"

Claude will then follow this workflow to interactively add the idea to the KANBAN.md file.