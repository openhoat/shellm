...
|----------|--------|----------|
| **Linux** | AppImage | [Termaid-1.4.0.AppImage](https://github.com/openhoat/termaid/releases/latest/download/Termaid-1.4.0.AppImage) |
| **Linux** | Debian/Ubuntu | [termaid_1.4.0_amd64.deb](https://github.com/openhoat/termaid/releases/latest/download/termaid_1.4.0_amd64.deb) |
| **macOS** | DMG (ARM) | [Termaid-1.4.0-arm64.dmg](https://github.com/openhoat/termaid/releases/latest/download/Termaid-1.4.0-arm64.dmg) |
| **Windows** | Installer | [Termaid.Setup.1.4.0.exe](https://github.com/openhoat/termaid/releases/latest/download/Termaid.Setup.1.4.0.exe) |
