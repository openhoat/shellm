...
export const ENV_VAR_OLLAMA_URL = 'TERMAID_OLLAMA_URL'
export const ENV_VAR_OLLAMA_API_KEY = 'TERMAID_OLLAMA_API_KEY'
export const ENV_VAR_OLLAMA_MODEL = 'TERMAID_OLLAMA_MODEL'
export const ENV_VAR_OLLAMA_TEMPERATURE = 'TERMAID_OLLAMA_TEMPERATURE'
export const ENV_VAR_OLLAMA_MAX_TOKENS = 'TERMAID_OLLAMA_MAX_TOKENS'
export const ENV_VAR_CLAUDE_API_KEY = 'TERMAID_CLAUDE_API_KEY'
export const ENV_VAR_ANTHROPIC_API_KEY = 'ANTHROPIC_API_KEY'
export const ENV_VAR_CLAUDE_MODEL = 'TERMAID_CLAUDE_MODEL'
export const ENV_VAR_OPENAI_API_KEY = 'TERMAID_OPENAI_API_KEY'
export const ENV_VAR_OPENAI_MODEL = 'TERMAID_OPENAI_MODEL'
export const ENV_VAR_SHELL = 'TERMAID_SHELL'
